...
vim.api.nvim_set_hl(0, 'Search',      { fg = magenta, ctermfg = cterm_magenta, bg = black,   ctermbg = cterm_black })
vim.api.nvim_set_hl(0, 'CurSearch',   { fg = black,   ctermfg = cterm_black,   bg = magenta, ctermbg = cterm_magenta })
...
vim.api.nvim_set_hl(0, 'PmenuMatch',    { fg = magenta, ctermfg = cterm_magenta, bg = black,        ctermbg = cterm_black })
...
vim.api.nvim_set_hl(0, 'PmenuMatchSel', { fg = magenta, ctermfg = cterm_magenta, bg = bright_black, ctermbg = cterm_bright_black, bold = true })
...
vim.api.nvim_set_hl(0, 'MatchParen', { fg = magenta, ctermfg = cterm_magenta })
